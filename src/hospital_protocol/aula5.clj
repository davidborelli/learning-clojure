...
(let [particular {:id 15, :nome "David", :nascimento "27/09/1989", :situacao :urgente }
      plano {:id 16, :nome "Guilherme", :nascimento "27/10/1988", :situacao :urgente, :plano [:raio-x, :ultrasom] }]
...
(let [particular {:id 15, :nome "David", :nascimento "27/09/1989", :situacao :normal }
      plano {:id 16, :nome "Guilherme", :nascimento "27/10/1988", :situacao :normal, :plano [:raio-x, :ultrasom] }]
  (pprint (deve-assinar-pre-autorizacao? {:paciente particular, :valor 1000, :procedimento :coleta-de-sangue }))
  (pprint (deve-assinar-pre-autorizacao? {:paciente plano, :valor 1000, :procedimento :coleta-de-sangue })))